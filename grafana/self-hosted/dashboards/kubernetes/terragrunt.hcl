...
#-------------------------------------------------------------------------------
locals {
  enabled = can(include.root.locals.env_vars.locals.dashboard.kubernetes) ? try(include.root.locals.env_vars.locals.dashboard.kubernetes.enabled, true) : false
}
